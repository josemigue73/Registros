...
public class frmusuariologin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Ingreso al Sistema RECOL", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(153, 255, 51))); // NOI18N
        ...
        btningresar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/guardar.png"))); // NOI18N
    ...
    private void btningresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresarActionPerformed
        ...
        try {
            ...
            if (func.totalregistros >0) {
                ...
                frminicio.lblP_apellido.setText(tablalistado.getValueAt(0, 2).toString());
                frminicio.lblS_apellido.setText(tablalistado.getValueAt(0, 3).toString());
                frminicio.lblacceso.setText(tablalistado.getValueAt(0, 4).toString());
                
                if (!frminicio.lblacceso.getText().equals("Administrador")) {
                    frminicio.mnuarchivos.setEnabled(false);
